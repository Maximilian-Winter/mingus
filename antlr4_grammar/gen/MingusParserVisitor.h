...
public:
   ...
   */
    ...
    virtual std::any visitAttribute(MingusParser::AttributeContext *context) = 0;
    ...
    virtual std::any visitTaggedUnionDeclaration(MingusParser::TaggedUnionDeclarationContext *context) = 0;

    virtual std::any visitTaggedUnionVariant(MingusParser::TaggedUnionVariantContext *context) = 0;

    virtual std::any visitTaggedUnionField(MingusParser::TaggedUnionFieldContext *context) = 0;
    ...
    virtual std::any visitVariantPatternField(MingusParser::VariantPatternFieldContext *context) = 0;
