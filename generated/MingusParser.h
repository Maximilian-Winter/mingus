...
public:
  enum {
    ...
    UnderscoreWildcard = 106, OpeningRoundBracket = 107, ClosingRoundBracket = 108, 
    SquareBracketLeft = 109, SquareBracketRight = 110, FloatingLiteral = 111, 
    IntegerLiteral = 112, CharLiteral = 113, Identifier = 114, BLOCK_COMMENT = 115, 
    LINE_COMMENT = 116, WS = 117, DQUOTE = 118, CURLY_L = 119, CURLY_R = 120, 
    TEXT = 121, BACKSLASH_PAREN = 122, ESCAPE_SEQUENCE = 123
  };
  ...
  enum {
    ...
    RuleUnionBlock = 33, RuleUnionMember = 34, RuleTaggedUnionDeclaration = 35, 
    RuleTaggedUnionVariant = 36, RuleTaggedUnionField = 37, RuleEnumDeclaration = 38, 
    RuleEnumMember = 39, RuleFunctionDeclaration = 40, RuleReturnType = 41, 
    RuleDefinitionParameters = 42, RuleParameterList = 43, RuleParameter = 44, 
    RuleVariableDeclaration = 45, RuleConstVariableDeclaration = 46, RuleTypedVariableDeclaration = 47, 
    RuleInferredVariableDeclaration = 48, RuleTupleDestructuring = 49, RuleTupleDestructureElement = 50, 
    RuleStatement = 51, RuleBlock = 52, RuleExprStatement = 53, RuleRawBlock = 54, 
    RuleIfStatement = 55, RuleElseIfClause = 56, RuleElseClause = 57, RuleSwitchStatement = 58, 
    RuleSwitchCase = 59, RuleSwitchDefault = 60, RuleMatchStatement = 61, 
    RuleMatchExpression = 62, RuleMatchArm = 63, RuleMatchBody = 64, RulePattern = 65, 
    RuleGuardedPattern = 66, RuleBasePattern = 67, RuleLiteralPattern = 68, 
    RuleRangePattern = 69, RuleWildcardPattern = 70, RuleBindingPattern = 71, 
    RuleTuplePattern = 72, RuleVariantPatternField = 73, RuleForStatement = 74, 
    RuleForInitializer = 75, RuleLocalVarInitializer = 76, RuleLocalVarDeclaration = 77, 
    RuleForIterator = 78, RuleWhileStatement = 79, RuleDoWhileStatement = 80, 
    RuleReturnStatement = 81, RuleLabeledStatement = 82, RuleBreakStatement = 83, 
    RuleContinueStatement = 84, RuleDeleteStatement = 85, RuleExpression = 86, 
    RuleAssignment = 87, RuleAssignmentOperator = 88, RuleLambdaExpression = 89, 
    RuleCaptureList = 90, RuleCaptureDefault = 91, RuleCaptureItem = 92, 
    RuleLambdaParameterList = 93, RuleLambdaParameter = 94, RulePipe = 95, 
    RulePipeTarget = 96, RuleTernary = 97, RuleLogicOr = 98, RuleLogicAnd = 99, 
    RuleBitwiseOr = 100, RuleBitwiseXor = 101, RuleBitwiseAnd = 102, RuleEquality = 103, 
    RuleRelational = 104, RuleShift = 105, RuleAdditive = 106, RuleMultiplicative = 107, 
    RuleCastExpression = 108, RuleUnaryExpression = 109, RulePostfixExpression = 110, 
    RulePrimaryExpression = 111, RuleArrayLiteral = 112, RulePostfixOperation = 113, 
    RuleNewExpression = 114, RuleCallArguments = 115, RuleArgumentList = 116, 
    RuleElementAccess = 117, RuleMemberAccess = 118, RuleTupleExpression = 119, 
    RuleTypeIdentifier = 120, RulePrimitiveType = 121, RuleFunctionType = 122, 
    RuleTypeList = 123, RuleTupleType = 124, RuleTypeModifier = 125, RuleRvalueReferenceLevel = 126, 
    RuleReferenceLevel = 127, RuleArrayDimension = 128, RulePointerLevel = 129, 
    RuleAccessModifier = 130, RuleStaticModifier = 131, RuleAbstractModifier = 132, 
    RuleQualifiedName = 133, RulePrefixOperator = 134, RuleIncrementDecrementOperator = 135, 
    RuleTypeSizeOrAlign = 136, RuleString = 137, RuleStringPart = 138
  };
